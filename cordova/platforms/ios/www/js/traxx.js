...
var chan;
var socket;
var backend_server = 'http://127.0.0.1:8080'
...
function join_chat() {
    $.ajax({
        type: "POST",
        url: backend_server + '/chat/join_chat/',
...
function get_notifications() {
    ...
    $.ajax({
        type: "GET",
        url: backend_server + '/notifications/',
...
function clear_notification(notification_id) {
    $.ajax({
        type: "DELETE",
        url: backend_server + '/notifications/' + notification_id + '/',
        success: function(results) {
